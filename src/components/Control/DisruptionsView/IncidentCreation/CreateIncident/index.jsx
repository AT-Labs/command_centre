...
export class CreateIncident extends React.Component {
    ...
    onSubmit = async () => {
        ...
        this.props.createIncident(buildSubmitBody(disruption, this.props.routes, this.props.stops, incidentData.workarounds));
    };
    ...
    render() {
        ...
        const renderMainHeading = () => {
            const titleByMode = {
                [EDIT_TYPE.CREATE]: 'Create a new Cause',
                [EDIT_TYPE.COPY]: `Copy Cause #${this.props.incidentToEdit.incidentNo}`,
                [EDIT_TYPE.EDIT]: 'Edit Cause',
            };
