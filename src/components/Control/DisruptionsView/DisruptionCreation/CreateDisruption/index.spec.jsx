...
describe('CreateDisruption component', () => {
    ...
    describe('onSubmitDraft', () => {
        ...
        it('should handle recurrent disruption with empty startDate and startTime without error', async () => {
            const disruptionData = {
                recurrent: true,
                startDate: '',
                startTime: '',
            ...
            expect(callArgs.startTime).toBeUndefined();
            expect(callArgs.endTime).toBeUndefined();
            expect(callArgs.recurrencePattern.dtstart).toBeUndefined();
            expect(callArgs.recurrencePattern.until).toBeUndefined();
        });
