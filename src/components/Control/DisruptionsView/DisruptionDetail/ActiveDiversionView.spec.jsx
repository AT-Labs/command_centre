...
describe('<ActiveDiversionView />', () => {
    ...
    it('createRenderCell renders single value for a diversionRouteVariant', () => {
        const createRenderCell = (property = '') => ({ row }) => (
    ...
    describe('createRenderCell', () => {
        it('Diversions with no diversionRouteVariants are not displayed', () => {
            const expandedRows = { DIV123: true, DIV456: true };
            render(
                <ActiveDiversionView
                    diversions={ mockDiversions }
