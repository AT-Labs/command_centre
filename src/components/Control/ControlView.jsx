...
const ControlViewComponent = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.useEditEffectPanel && 
            ...
            if (disruptionToEdit) {
                console.log('🔧 Setting disruptionIncidentNoToEdit but NOT opening EditEffectPanel');
                // props.toggleEditEffectPanel(true); // DISABLED - should only open on DISR{id} click
                console.log('🔧 EditEffectPanel will be hidden until DISR{id} is clicked');
            } else {
