...
const ViewDiversionDetailModal = (props) => {
    console.log('🔧 ViewDiversionDetailModal render');
    console.log('🔧 props.isOpen:', props.isOpen);
    console.log('🔧 props.disruption:', props.disruption);
    console.log('🔧 props.diversions:', props.diversions);
    
    // Add more detailed logging
    if (props.isOpen) {
        console.log('🔧 ===== ViewDiversionDetailModal IS OPENING =====');
        console.log('🔧 Modal title will be:', `Diversions on Disruption ${props.disruption.incidentNo}`);
