...
export const EditEffectPanel = (props) => {
    ...
    const startTimeValid = () => isEffectStartTimeValid(
    ...
    const updateDisruption = (updatedFields) => {
        ...
        if (updatedFields?.startDate || updatedFields?.startTime || updatedFields?.endDate || updatedFields?.endTime) {
            const updatedEffects = props.disruptions.map(d => 
                d.incidentNo === safeDisruption.incidentNo ? updatedDisruption : d
            );
            const updatedParentDisruption = updateParentDisruptionTimeRange(
                props.disruptions[0],
                updatedEffects
            );
