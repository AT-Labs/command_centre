...
export const EditEffectPanel = (props) => {
    ...
    return (
        <div className={ `edit-effect-panel ${!props.isEditEffectPanelOpen ? 'hidden' : ''}` }>
                    ...
                    <div className="edit-effect-panel-body">
                        <div className="label-with-icon">
                            <h2 className="pl-4 pr-4 pt-4">
                                ...
                                <button 
                                    type="button" 
                                    className="btn cc-btn-link p-lr12-tb6 m-0 btn btn-secondary"
                                    onClick={ (e) => {
                                        e.preventDefault();
                                        e.stopPropagation();
                                    ...
                                    style={{
                                        visibility: props.isEditEffectPanelOpen ? 'hidden' : 'visible',
                                        position: props.isEditEffectPanelOpen ? 'absolute' : 'fixed',
                                        top: props.isEditEffectPanelOpen ? 'auto' : '20px',
                                        left: props.isEditEffectPanelOpen ? 'auto' : '20px',
                                        zIndex: props.isEditEffectPanelOpen ? -1 : 999999,
                                        background: props.isEditEffectPanelOpen ? 'transparent' : 'red',
                                        color: props.isEditEffectPanelOpen ? 'inherit' : 'white',
                                        padding: props.isEditEffectPanelOpen ? 'inherit' : '15px',
                                        border: props.isEditEffectPanelOpen ? 'none' : '3px solid #333',
                                        borderRadius: props.isEditEffectPanelOpen ? '0' : '10px',
                                        fontSize: props.isEditEffectPanelOpen ? 'inherit' : '18px',
                                        fontWeight: 'bold',
                                        cursor: 'pointer'
                                    }}
                                >
