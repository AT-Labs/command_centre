...
describe('Confirmation Component', () => {
    ...
    describe('UI Handlers', () => {
        ...
        it('should render View & Edit Diversions button when menu is open', () => {
            ...
            const diversionsButton = getByText((content, element) => {
                return element.tagName.toLowerCase() === 'span' && content.includes('Diversions(');
            });
        ...
        it('should toggle the menu open state when Diversions button is clicked', () => {
            ...
            const diversionsButtonSpan = getByText((content, element) => {
                return element.tagName.toLowerCase() === 'span' && content.includes('Diversions(');
            });
