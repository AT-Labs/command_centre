...
describe('Confirmation Component', () => {
    ...
    describe('Fetched Disruption ShapeWkt Merge', () => {
        it('should merge shapeWkt from current disruption into fetched disruption', () => {
            const disruption = {
                affectedEntities: {
                    affectedRoutes: [
                        { routeId: '101-202', routeShortName: '101-to-be-replaced', shapeWkt: 'LINESTRING(0 0, 1 1)' },
                        { routeId: '105-202', routeShortName: '105-to-be-replaced', shapeWkt: 'LINESTRING(2 2, 3 3)' },
                    ],
                    affectedStops: [],
                },
            };
            ...
            const fetchedDisruption = {
                affectedEntities: [
                    { routeId: '101-202-fetched', routeShortName: '101-fetched' },
                    { routeId: '105-202-fetched', routeShortName: '105-fetched' },
                    { routeId: '999-202-fetched', routeShortName: '999-fetched' },
                ],
            };
            ...
            expect(setDisruption).toHaveBeenCalledWith({
                ...disruption,
                affectedEntities: {
