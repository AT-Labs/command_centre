...
import { getAffectedRoutes, getAffectedStops } from '../../../../../redux/selectors/control/incidents';
...
const DiversionsButton = ({
    ...
    const reduxAffectedRoutes = getAffectedRoutes(state);
    
    const localAffectedEntities = useAffectedEntities(disruption, reduxAffectedRoutes);
    const affectedEntities = reduxAffectedRoutes && reduxAffectedRoutes.length > 0
        ? reduxAffectedRoutes
        : localAffectedEntities;
    ...
    return (
        <div className="diversions-button-container">
            <Button
                ...
                disabled={ false }
            >
                <span style={ { color: STYLES.COLORS.TEXT } }>
                    Diversions(
                    {diversionCount}
                    )
                </span>
                <img
                    ...
                    style={ { marginLeft: STYLES.ICON.MARGIN_LEFT } }
                />
            </Button>
                ...
                >
                    <div
                        ...
                        style={ {
                            ...
                            opacity: isAddDiversionEnabled ? STYLES.OPACITY.ENABLED : STYLES.OPACITY.DISABLED,
                        } }
                    >
                        Add Diversion
                    </div>
