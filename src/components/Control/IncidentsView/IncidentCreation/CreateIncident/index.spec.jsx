...
describe('CreateIncident component', () => {
    ...
    describe('Entity Limit Validation', () => {
        ...
        it('should show alert modal when entities exceed 200 limit on publish', () => {
        ...
        it('should not show alert modal when entities are within 200 limit on publish', () => {
        ...
        it('should show alert modal when entities exceed 200 limit on save draft', () => {
            const disruption = createDisruptionWithEntities(150, 100);
            const incidentData = {
                ...defaultIncidentData,
                disruptions: [disruption],
            ...
            wrapper.instance().onSaveDraft();
            expect(wrapper.find('IncidentLimitModal').prop('isOpen')).toBe(true);
            expect(wrapper.find('IncidentLimitModal').prop('totalEntities')).toBe(250);
        });

        it('should not show alert modal when entities are within 200 limit on save draft', () => {
            const disruption = createDisruptionWithEntities(100, 50);
            const incidentData = {
                ...defaultIncidentData,
                disruptions: [disruption],
