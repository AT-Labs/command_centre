...
export class CreateIncident extends React.Component {
    ...
    onSubmit = async () => {
        ...
        console.warn('onSubmit incidentData', incident);
        this.props.createNewIncident(buildIncidentSubmitBody(incident)); // TODO
    };
    ...
    onSubmitDraft = async () => {
        ...
        console.warn('onSubmitDraft incidentData', incident);
        this.props.createNewIncident(buildIncidentSubmitBody(incident));
