            ...
            this.setState(prevState => ({
                incidentData: {
                    ...
                    disruptions: [
                        ...
                        {
                            key: action.resultIncidentId,
                            incidentNo: action.resultIncidentId,
                            startTime: prevState.incidentData.startTime,
                            startDate: prevState.incidentData.startDate,
                            endTime: prevState.incidentData.endTime,
                            endDate: prevState.incidentData.endDate,
                            impact: prevState.incidentData.disruptions[0]?.impact || 'UNKNOWN',
                            cause: prevState.incidentData.cause,
                            affectedEntities: prevState.incidentData.disruptions[0]?.affectedEntities || {
                                affectedRoutes: [],
                                affectedStops: [],
                            },
                            createNotification: false,
                            disruptionType: prevState.incidentData.disruptions[0]?.disruptionType || 'ROUTES',
                            severity: prevState.incidentData.severity,
                            recurrent: prevState.incidentData.recurrent,
                            duration: prevState.incidentData.duration,
                            recurrencePattern: prevState.incidentData.recurrencePattern,
                            header: prevState.incidentData.header,
                            status: 'not-started',
                        }
                    ]
                }
