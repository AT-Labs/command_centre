...
import { toggleIncidentModals, updateCurrentStep, toggleWorkaroundPanel, updateDisruptionToWorkaroundEdit } from '../../../../../redux/actions/control/incidents';
...
export const Workarounds = (props) => {
    ...
    const openWorkaroundPanel = (disruption) => {
        props.updateDisruptionToWorkaroundEdit(disruption);
...
}), { toggleIncidentModals, updateCurrentStep, toggleWorkaroundPanel, updateDisruptionToWorkaroundEdit })(Workarounds);
