...
describe('<SelectedEntitiesRenderer />', () => {
    ...
    describe('getStopsUnderRoute - default values for affectedRoutes and affectedStops', () => {
        it('should use empty arrays when affectedRoutes is undefined', () => {
            const affectedEntities = {
                affectedRoutes: undefined,
                affectedStops: [
                    {
        ...
        it('should use empty arrays when affectedStops is undefined', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
        ...
        it('should use empty arrays when both affectedRoutes and affectedStops are undefined', () => {
            const affectedEntities = {
                affectedRoutes: undefined,
                affectedStops: undefined,
            };
    ...
    describe('getRoutesUnderStop - default values for affectedRoutes and affectedStops', () => {
        it('should use empty arrays when affectedRoutes is undefined in getRoutesUnderStop', () => {
            const affectedEntities = {
                affectedRoutes: undefined,
                affectedStops: [
                    {
        ...
        it('should use empty arrays when affectedStops is undefined in getRoutesUnderStop', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
    ...
    describe('RouteWithStops - routeKey useMemo', () => {
        it('should use routeShortName when routeId is not present', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeShortName: '101',
        ...
        it('should use routeId when both routeId and routeShortName are present', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
    ...
    describe('RouteWithStops - directionLabel fallback', () => {
        it('should use fallback when directionId is not in DIRECTIONS', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
            ...
            const directionContent = wrapper.find('.disruption-effect-item-stop.pl-4');
            expect(directionContent.exists()).toBe(true);
            expect(directionContent.text()).toContain('Direction 99');
        });

        it('should use DIRECTIONS value when directionId exists in DIRECTIONS', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
            ...
            const directionContent = wrapper.find('.disruption-effect-item-stop.pl-4');
            expect(directionContent.exists()).toBe(true);
            expect(directionContent.text()).toContain('Inbound/Anticlockwise');
        });
    });

    describe('SelectedEntitiesRenderer - key generation with routeId fallback', () => {
        it('should use routeShortName in key when routeId is not present', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeShortName: '101',
        ...
        it('should use routeId in key when routeId is present', () => {
            const affectedEntities = {
                affectedRoutes: [
                    {
                        routeId: '101-202',
