...
describe('<Footer />', () => {
    ...
    it('should render columns with "col-2" when showFinishButton and isAddEffectsStep are true', () => {
        useDraftDisruptions.mockReturnValue(true);

        const wrapper = setup({ isDraftOrCreateMode: true, showFinishButton: true, isAddEffectsStep: true });
