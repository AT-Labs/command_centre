...
export const DisruptionDetailSelect = (props) => {
    ...
    return (
        <FormGroup className={ `${props.className} position-relative` }>
            ...
            <Input type="select"
                className="w-100 border border-dark incident-creation__wizard-select-details__select position-relative"
                disabled={ disabled }
                id={ id }
                value={ value }
                invalid={ invalid }
            ...
            { !invalid && (
                <IoIosArrowDropdown className="incident-creation__wizard-select-details__icon position-absolute" size={ 22 } />
            )}
