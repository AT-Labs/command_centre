...
export class IncidentsView extends React.Component {
    ...
    render() {
        ...
        const paginatedDisruptions = filteredDisruptions.slice(startIndex, startIndex + PAGE_SIZE);
        ...
        console.log('Pagination incidents length', filteredIncidents.length);
        console.log('Pagination PAGE_SIZE', PAGE_SIZE);
        return (
                ...
                {!isCreateOpen
                    && (
                        <div className="ml-4 mr-4">
                            ...
                            <IncidentsDataGrid
                                page={ currentPage }
                                disruptions={ paginatedDisruptions }
