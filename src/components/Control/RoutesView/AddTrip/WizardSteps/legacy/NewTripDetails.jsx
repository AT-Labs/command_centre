...
import { getTripTimeDisplay, convertTimeToMinutes, getDifferenceInMinutes, addMinutesToTime } from '../../../../../../utils/helpers';
...
export const NewTripDetails = forwardRef((props, ref) => {
    ...
    const handleStartTimeChange = (event) => {
        ...
        const newEndTime = isNewStartTimeInvalid ? '' : addMinutesToTime(props.tripInstance.endTime, getDifferenceInMinutes(props.tripInstance.startTime, value));
        ...
        <div className="add-trip-new-trip-details p-3">
            ...
            <div className="add-trip-new-trip-details__content">
                ...
                { shouldStopSelectionFooterBeShown
                    ? (
                        <StopSelectionFooter tripInstance={ addPermissions(newTrip) } onStopUpdated={ handleStopUpdate } />
                    )
                    : (
