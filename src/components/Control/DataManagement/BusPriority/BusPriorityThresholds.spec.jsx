...
jest.mock('./BusPriorityThresholdsModal', () => {
    const MockThresholdModal = ({ isModalOpen, onClose, mode, thresholdSet, saveNewThresholds, deleteThresholds }) => {
        ...
        return (
            <div data-testid="threshold-modal">
                ...
                <button data-testid="modal-save" onClick={() => saveNewThresholds({ test: 'data' })}>Save</button>
                <button data-testid="modal-delete" onClick={() => deleteThresholds(thresholdSet)}>Delete</button>
            </div>
        );
    };
