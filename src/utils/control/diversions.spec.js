import { STATUSES as DISRUPTION_STATUSES } from '../../types/disruptions-types';
import {
...
describe('Diversions Utils', () => {
    ...
    describe('canFetchDiversions', () => {
        ...
        it('should return falsy when fetchDiversionsAction is not provided or disruption is null/undefined', () => {
            const disruption = { disruptionId: '123' };
            const fetchDiversionsAction = jest.fn();
    ...
    describe('getAffectedEntities', () => {
        ...
        it('should return disruption affectedRoutes when reduxAffectedRoutes is empty', () => {
            const disruption = { affectedEntities: { affectedRoutes: [{ routeId: '1' }] } };
    ...
    describe('getDiversionValidation', () => {
        ...
        it('should return true for NOT_STARTED and DRAFT status without startTime/endTime', () => {
            const notStartedDisruption = { ...mockDisruption, status: DISRUPTION_STATUSES.NOT_STARTED, startTime: null, endTime: null };
            const draftDisruption = { ...mockDisruption, status: DISRUPTION_STATUSES.DRAFT, startTime: null, endTime: null };

            expect(getDiversionValidation(notStartedDisruption, mockAffectedEntities)).toBe(true);
            expect(getDiversionValidation(draftDisruption, mockAffectedEntities)).toBe(true);
        });
        ...
        it('should handle edge cases for diversions', () => {
            const affectedEntities = [{ routeId: '1', routeType: 3 }]; // bus route
