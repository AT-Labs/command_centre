...
describe('getDisruptionsUniqueStops', () => {
    const disruptions = [
        ...
        },
        {
            ...
            affectedEntities: [
                ...
                {
                    stopId: '133-b84b56d3',
                    stopName: 'Britomart Train Station',
                    stopCode: '133',
                    locationType: 1,
                    stopLat: -36.84429,
                    stopLon: 174.76847,
                ...
                {
                    stopId: '9001-3be05f0c',
                    stopName: 'Britomart Train Station 1',
                    stopCode: '9001',
                    locationType: 0,
                    stopLat: -36.84429,
                    stopLon: 174.76847,
                    parentStation: '133-b84b56d3',
                    platformCode: '1',
                    routeType: 2,
                    text: '9001 - Britomart Train Station 1',
                    category: null,
                    icon: null,
                    valueKey: 'stopId',
                    labelKey: 'stopCode',
                ...
                {
                    stopId: '9002-8ff96893',
                    stopName: 'Britomart Train Station 2',
                    stopCode: '9002',
                    locationType: 0,
                    stopLat: -36.84429,
                    stopLon: 174.76847,
                    ...
                    platformCode: '2',
                    routeType: 2,
                    text: '9002 - Britomart Train Station 2',
                    category: null,
                    icon: null,
                    valueKey: 'stopId',
                    labelKey: 'stopCode',
                ...
                {
                    stopId: '9003-4011937f',
                    stopName: 'Britomart Train Station 3',
                    stopCode: '9003',
                    locationType: 0,
                    stopLat: -36.84429,
                    stopLon: 174.76847,
                    ...
                    platformCode: '3',
                    routeType: 2,
                    text: '9003 - Britomart Train Station 3',
                    category: null,
                    icon: null,
                    valueKey: 'stopId',
                    labelKey: 'stopCode',
    ...
    it('should handle disruptions with empty affectedEntities', () => {
        const disruptionsWithEmptyEntities = [
            { disruptionId: 1, affectedEntities: [] },
            { disruptionId: 2, affectedEntities: [] },
        ];
        const uniqueStops = getDisruptionsUniqueStops(disruptionsWithEmptyEntities);
        expect(uniqueStops).to.deep.equal([]);
    });

    it('should handle disruptions with mixed valid and invalid entities', () => {
        const mixedEntities = [
            {
                disruptionId: 1,
                affectedEntities: [
                    { stopCode: '1234', type: 'stop' },
                    { stopCode: '5678', type: 'route' },
                    { stopCode: '4321', type: 'stop' },
                ],
            },
        ];
        const uniqueStops = getDisruptionsUniqueStops(mixedEntities);
        expect(uniqueStops).to.deep.equal([
            { stopCode: '1234', type: 'stop' },
            { stopCode: '4321', type: 'stop' },
        ]);
    ...
    it('should handle duplicate stopCodes across multiple disruptions', () => {
        ...
        const uniqueStops = getDisruptionsUniqueStops(duplicateStops);
        expect(uniqueStops).to.deep.equal([
            { stopCode: '1234', type: 'stop' },
        ]);
    });
