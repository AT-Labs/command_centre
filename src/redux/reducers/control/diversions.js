...
const handleSetDiversionManagerLoading = (state, { payload: { isLoading } }) => ({
    ...state,
    isDiversionManagerLoading: isLoading,
});
...
export default handleActions({
    ...
    [ACTION_TYPE.SET_DIVERSION_MANAGER_LOADING]: handleSetDiversionManagerLoading,
