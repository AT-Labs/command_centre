...
describe('Diversions Reducer', () => {
    ...
    describe('CLEAR_DIVERSIONS_CACHE', () => {
        it('should handle clearing diversions cache for specific disruption', () => {
            ...
            expect(result.diversionsData[disruptionId]).toBeUndefined();
            expect(result.diversionsData[456]).toEqual([{ id: '2' }]);
            expect(result.diversionsLoading[disruptionId]).toBeUndefined();
            expect(result.diversionsError[disruptionId]).toBeUndefined();
        });
