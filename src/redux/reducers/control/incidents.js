...
const handleDisruptionToWorkaroundEdit = (state, { payload: { disruptionToWorkaroundEdit } }) => ({ ...state, disruptionToWorkaroundEdit });
...
export default handleActions({
    ...
    [ACTION_TYPE.UPDATE_DISRUPTION_TO_WORKAROUND_EDIT]: handleDisruptionToWorkaroundEdit,
}, INIT_STATE);
