...
export const getAddRecurringCancellationOperatorErrorDisplay = createSelector(getAddRecurringCancellationsDetails, recurringCancellationsDetails => _.result(recurringCancellationsDetails, 'displayError'));
