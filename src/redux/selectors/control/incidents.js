...
export const getAllIncidents = createSelector(getIncidentsState, incidentsState => result(incidentsState, 'disruptions'));
...
export const getActiveIncidentId = createSelector(getIncidentsState, action => result(action, 'activeDisruptionId'));
