...
export const isAnyError = createSelector(getActivityState,
    activityState => !_.isUndefined(_.find(_.result(activityState, 'error'), error => !_.isNull(error))));

export const hasPrerequisiteDataLoaded = createSelector(hasFleetLoaded, hasRoutesLoaded, hasStopsLoaded,
