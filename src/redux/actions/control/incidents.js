...
export const updateDisruptionToWorkaroundEdit = disruptionToWorkaroundEdit => ({
    type: ACTION_TYPE.UPDATE_DISRUPTION_TO_WORKAROUND_EDIT,
    payload: {
        disruptionToWorkaroundEdit,
    },
});
