...
describe('Diversions Actions', () => {
    ...
    describe('Synchronous Actions', () => {
        ...
        it('should create fetchDiversionsStart action', () => {
            ...
            const action = diversionsActions.fetchDiversionsStart(disruptionId);
            expect(action).toEqual(expectedAction);
        });

        it('should create fetchDiversionsSuccess action', () => {
            const disruptionId = '123';
            ...
            const action = diversionsActions.fetchDiversionsSuccess(disruptionId, diversions);
            expect(action).toEqual(expectedAction);
        });

        it('should create fetchDiversionsError action', () => {
            const disruptionId = '123';
            ...
            const action = diversionsActions.fetchDiversionsError(disruptionId, error);
            expect(action).toEqual(expectedAction);
        });
    ...
    describe('Diversion Flow Access Integration', () => {
        it('should handle diversion manager state changes correctly', () => {
            ...
            const expectedActions = [
                {
                    type: ACTION_TYPE.OPEN_DIVERSION_MANAGER,
                    payload: { isDiversionManagerOpen: isOpen },
                },
            ];

            store.dispatch(diversionsActions.openDiversionManager(isOpen));
            expect(store.getActions()).toEqual(expectedActions);
        });

        it('should handle diversion mode updates for create flow', () => {
            const editMode = EDIT_TYPE.CREATE;
            const expectedActions = [
                {
                    type: ACTION_TYPE.UPDATE_DIVERSION_EDIT_MODE,
                    payload: { diversionEditMode: editMode },
                },
            ];

            store.dispatch(diversionsActions.updateDiversionMode(editMode));
            expect(store.getActions()).toEqual(expectedActions);
        });

        it('should handle diversion mode updates for edit flow', () => {
            const editMode = EDIT_TYPE.EDIT;
            const expectedActions = [
                {
                    type: ACTION_TYPE.UPDATE_DIVERSION_EDIT_MODE,
        ...
        it('should handle diversion to edit updates', () => {
            ...
            store.dispatch(diversionsActions.updateDiversionToEdit(diversionToEdit));
            expect(store.getActions()).toEqual(expectedActions);
        });
        ...
        it('should handle loading state changes during diversion operations', () => {
            ...
            store.dispatch(diversionsActions.setDiversionManagerLoading(isLoading));
            expect(store.getActions()).toEqual(expectedActions);
        });

        it('should handle diversion manager close with proper state reset', () => {
            const expectedActions = [
                {
                    type: ACTION_TYPE.OPEN_DIVERSION_MANAGER,
            ...
            store.dispatch(diversionsActions.openDiversionManager(false));
            expect(store.getActions()).toEqual(expectedActions);
        });
    });
});
