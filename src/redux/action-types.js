export default {
    ...
    UPDATE_CONTROL_INCIDENT_FOR_EDIT_LOADING: 'update-control-incident-for-edit-loading',
    ...
    SET_EDIT_EFFECT_PANEL_STATUS: 'set-edit-effect-panel-status',
    UPDATE_DISRUPTION_KEY_TO_WORKAROUND_EDIT: 'update-disruption-key-to-workaround-edit',
    UPDATE_DISRUPTION_KEY_TO_EDIT_EFFECT: 'update-disruption-key-to-edit-effect',
    UPDATE_EFFECT_REQUIRES_TO_UPDATE_NOTES: 'update-control-effect-requires-to-update-notes',
    UPDATE_WORKAROUNDS_NEED_TO_BE_UPDATED: 'update-control-workarounds-need-to-be-updated',
    ...
    UPDATE_SELECTED_EFFECT: 'update-selected-effect',
